...
// Read the architecture files and convert newlines
const summary = fs.readFileSync('/data/workspace/memory/architecture-shareable-summary.md', 'utf-8').replace(/\n/g, '\r\n');
const review = fs.readFileSync('/data/workspace/memory/architecture-review-devops.md', 'utf-8').replace(/\n/g, '\r\n');
...
console.log('Creating architecture review draft via IMAP APPEND...\n');
