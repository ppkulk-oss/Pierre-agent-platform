...
// All March dates from the schedule
const marchDates = [
    '20260316', '20260317', '20260318', '20260319', '20260320'  // Week 1
];
...
async function main() {
    console.log('Removing all March call entries...\n');
    for (const date of marchDates) {
        const status = await deleteEvent('kulkarni-' + date + '.ics');
        console.log(`${date}: ${status === 204 ? '✅ Deleted' : status === 404 ? 'Not found' : status}`);
    }
    console.log('\nDone');
}
